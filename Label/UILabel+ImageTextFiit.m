...
#import "UILabel+ImageTextFiit.h"

@implementation UILabel (ImageTextFiit)
...
{
    if(image){
        //        YWTextAttachment *attachment = [[YWTextAttachment alloc] initWithRect:bounds];
